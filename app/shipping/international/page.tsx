    ...
    setCountries([
      {
        ...
        estimatedDays: { express: "1-3", standard: "5-7", economy: "10-14" },
        restrictions: ["No lithium batteries", "Food items require permits"],
      ...
      },
      {
        ...
        estimatedDays: { express: "1-2", standard: "3-5" },
        restrictions: ["No tobacco products", "Alcohol requires license"],
        customsForms: ["CN22"],
      },
      {
        code: "AU",
        name: "Australia",
        services: ["Express", "Standard", "Economy"],
        estimatedDays: { express: "2-4", standard: "7-10", economy: "14-21" },
        restrictions: ["Strict biosecurity laws", "No food items"],
        customsForms: ["CN22", "CN23"],
      },
    ])
  }, [])
