        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/swiftship" className="text-gray-300 hover:text-white">
                  SwiftShip
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/schedule-pickup" className="text-gray-300 hover:text-white">
                  Schedule Pickup
                </Link>
              </li>
              <li>
                <Link href="/rates" className="text-gray-300 hover:text-white">
                  Calculate Rates
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/swift-preview" className="text-gray-300 hover:text-white">
                  Swift Preview
                </Link>
              </li>
              <li>
                <Link href="/swift-box" className="text-gray-300 hover:text-white">
                  Swift Box
                </Link>
              </li>
              <li>
                <Link href="/business" className="text-gray-300 hover:text-white">
                  Business Services
                </Link>
              </li>
              <li>
                <Link href="/international" className="text-gray-300 hover:text-white">
                  International
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/claims" className="text-gray-300 hover:text-white">
                  File a Claim
                </Link>
              </li>
              <li>
